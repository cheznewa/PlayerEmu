...
ffmpeg -y -i "$1" -i $tmp/b.png -i $ICONSKIT/cur.png -filter_complex "[0]scale=768x576[g],[g][1]overlay=0:500[k],[k][2]overlay=144+(t*480/${TIME}):516[f]" -map "[f]" -map 0:1 -vcodec libx264 -acodec aac "$2_pause.avi"
